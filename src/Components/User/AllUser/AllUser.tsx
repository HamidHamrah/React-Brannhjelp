    ...
    const renderRows = () => {
        return users.map(user => (
            <TableRow key={user.id}>
                ...
                <TableCell>{user.role}</TableCell> {/* Displaying the user's role */}
                <TableCell>
    ...
    return (
        <div>
                ...
                <Table>
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell>Role</TableCell> {/* Added Role header */}
            ...
            <Snackbar open={snackbarOpen} autoHideDuration={6000} onClose={handleSnackbarClose}>
                <Alert onClose={handleSnackbarClose} severity={snackbarMessage.includes('successfully') ? 'success' : 'error'} sx={{ width: '100%' }}>
                    {snackbarMessage}
                </Alert>
            </Snackbar>
        </div>
